...
- [`cpmtools` documentation](http://cpmtools.sourceforge.net/) — Unix reference for working with the CP/M-style directory entries that influenced both NedoDOS and +3 DOS.
