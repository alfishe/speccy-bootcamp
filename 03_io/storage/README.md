...
| [tzx_format.md](tzx_format.md) | **.TZX file format** — Tomaz Kac's 1996 comprehensive format. 10-byte "ZXTape!" header + major/minor version. 30+ block types (#10 standard, #11 turbo with 8 timing params, #12 pure tone, #13 pulse sequence, #14 pure data, #15 direct recording, #20 silence, #21/#22 group, #23 jump, #24 loop, #30 text, #31 message, #32 archive info, #33 hardware type, #5A glue). Extension blocks #80–#FF. Current spec v1.13 (2008). Format of choice for preservation | 1081 |
| [csw_format.md](csw_format.md) | **.CSW Compressed Square Wave** — Simon Owen's 2001 pulse-level preservation format. Stores pulse widths in samples (typically 44100 Hz), RLE compression (1–255 = single byte; #00 + 2-byte count + 2-byte width = RLE). v1 (small header) vs v2 (32-byte structured header with metadata extension). For analog protections and raw captures. 20–50 KB per 48K program | 551 |
