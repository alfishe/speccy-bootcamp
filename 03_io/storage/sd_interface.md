...
- [DivMMC documentation](https://github.com/westonrf/divide-ide) — the canonical hardware reference for the DivMMC's `#E3`–`#E7` SPI-on-ZX-bus port map.
...
- [`marcov-twi/ZXMMC` GitHub repository](https://github.com/Zaxos/ZXMMC) — the original ZXMMC project source, documenting the SPI bit-bang sequence and port decode.
