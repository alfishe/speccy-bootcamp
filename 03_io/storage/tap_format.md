...
- [The .TAP specification](https://worldofspectrum.org/faq/reference/48krom.htm) — the canonical document for the .TAP format (very short, given the format's simplicity).
