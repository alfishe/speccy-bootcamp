...
| [z80_format.md](z80_format.md) | **.Z80 snapshot format** — the 1994 "rich" format by Glen Lleston (Z80 emulator). Three versions: v1 (48K only, 30-byte header), v2 (128K, 23-byte extension), v3 (clones/AY/peripherals, 54-byte extension). Hardware ID system (0–26+), RLE compression via #ED #ED marker, per-page storage | 671 |
