...
- [ZEsarUX documentation](https://github.com/chernandezba/zesarux) — emulator reference for the cross-platform compatibility issues that arise from the Pentagon's non-standard frame on modern displays.
