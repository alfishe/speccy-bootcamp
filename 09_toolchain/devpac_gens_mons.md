...
- [HiSoft DevPac manuals (versions 2, 3, 4)](https://worldofspectrum.org/) — the canonical reference for GENS and MONS commands, directives, and operating procedures. Original HiSoft documentation, archived at World of Spectrum.
- [HiSoft advertisements](https://archive.org/details/yoursinclair-magazine) in *Sinclair User*, *CRASH*, *Your Spectrum*, *Your Sinclair* (1983–1988) — launch-era documentation of DevPac versions and pricing
...
- [World of Spectrum archives](https://worldofspectrum.org/) — downloadable DevPac 1.0–4.0 TAP/TZX files for use in emulators, plus original HiSoft documentation
