...
- [ALASM](https://zxpress.ru/) and STS documentation (ZXASM's primary integration partners)
- Discussions on Russian retro-computing forums clarifying the relationship between ZXASM, [ALASM](https://zxpress.ru/), and XAS
- Comparison with contemporaries based on the documented feature sets of [ALASM](https://zxpress.ru/), XAS, and TNI ASM
