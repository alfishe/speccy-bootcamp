...
| [ay_vs_ym.md](ay_vs_ym.md) | **AY vs YM Technical Comparison** — DAC ladder differences, the YM's 5-bit envelope, DC offset, SEL pin, per-unit silicon variation, and how each major emulator models these details |
