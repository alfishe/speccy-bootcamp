...
- **Chris Smith, *The ZX Spectrum ULA Manual*** — explains the 128K gate array's role in AY clock generation and bus decode.
- **The Complete Spectrum ROM Disassembly** — documents the 48K ROM's AY-less behavior and the 128K ROM's AY initialization.
