...
| 6 | [pentagon_1024.md](pentagon_1024.md) | Pentagon 1024: the hand-built 1 MB maximum Pentagon (Born Dead #10) — all six bank bits inside #7FFD, #EFF7 control register (ext-RAM gate/video/turbo), GigaScreen, Gluk Reset Service, LPRINT cache, 1024SL factory consolidation, safe RAM detection |
