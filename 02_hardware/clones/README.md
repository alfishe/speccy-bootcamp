...
| 6 | [pentagon_1024.md](pentagon_1024.md) | Pentagon 1024: the hand-built 1 MB maximum Pentagon (Born Dead #10) — all six bank bits inside #7FFD, #EFF7 control register (ext-RAM gate/video/turbo), 16-colour video mode (16c: four-area 4-bit-per-pixel bitmap, seven-circuit schematic per Info Guide #8 v1.1, SL v2.x factory adoption, software census), GigaScreen, Gluk Reset Service, LPRINT cache, 1024SL factory consolidation, safe RAM detection |
...
| 10 | [other_clones.md](other_clones.md) | Soviet and Eastern Bloc clones: Moskva 48K/128K (first mass-produced Russian clone), Leningrad (Pentagon precursor), Hobbit (CP/M/Forth/LOGO), Mikrosha (state factory), Quorum 64/128/256 (T34VG1 gate array), LEC 48/528 (non-power-of-two RAM), Composite, Sintez (no memory contention), Robik (military factory, 1989-1994), Delta family (Zelenograd/Voronezh/Kazan/Tbilisi), Peters MC64/256 (Sprinter precursor), GrandRomMax/Grandboard 2+, plus 15 minor clones and **Eastern Bloc section** (Romania Felix HC series from 1985, Poland Elwro 800 Junior, Czechoslovakia Didaktik, Hungary HT 3080C, East Germany Spectral, Spain Inves, Argentina Czerweny, Brazil TK 90X/95) |
| 11 | [sizif_harlequin.md](sizif_harlequin.md) | Modern 48K recreations: Harlequin (Chris Smith, discrete CMOS, ~40 ICs) and Sizif-512 (**Eugene Lozovoy / `UzixLS`**, Altera MAX II EPM1270 CPLD, real Z80 Z84C0020 + real AY-3-8910, 4 machine modes 48K/128/+3e/Pentagon, 5 turbo speeds, ULAplus, integrated DivMMC + Z-Controller, Magic menu, optional WiFi, Rev.A-E1 board revisions) |
